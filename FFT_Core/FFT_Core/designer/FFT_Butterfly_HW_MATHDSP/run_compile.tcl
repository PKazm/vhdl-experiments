...
set_compile_info \
    ...
    -name {"Topcell"} \
    -value {"FFT_Butterfly_HW_MATHDSP"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Format"} \
    -value {"Verilog"}
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {C:\Users\Phoenix136\Dropbox\FPGA\Microsemi\FFT_Core\designer\FFT_Butterfly_HW_MATHDSP} \
    -design FFT_Butterfly_HW_MATHDSP \
    -fam SmartFusion2 \
    -die PA4M1000_N \
    -pkg tq144 \
    -merge_pdc 0
