...
set_compile_info \
    ...
    -name {"Topcell"} \
    -value {"I2C_LITEON_Op_Sens_test_sd"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Format"} \
    -value {"Verilog"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\Phoenix136\Dropbox\FPGA\Microsemi\I2C_Core\synthesis\I2C_LITEON_Op_Sens_test_sd.vm"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {C:\Users\Phoenix136\Dropbox\FPGA\Microsemi\I2C_Core\designer\I2C_LITEON_Op_Sens_test_sd} \
    -design I2C_LITEON_Op_Sens_test_sd \
    -fam SmartFusion2 \
    -die PA4M1000_N \
    -pkg tq144 \
    -merge_pdc 0
