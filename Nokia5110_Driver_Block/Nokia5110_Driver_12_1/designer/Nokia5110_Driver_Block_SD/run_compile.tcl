...
set_compile_info \
    ...
    -name {"Topcell"} \
    -value {"Nokia5110_Driver_Block_SD"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Format"} \
    -value {"Verilog"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\Phoenix136\Dropbox\FPGA\Microsemi\Nokia5110_Driver_12_1\synthesis\Nokia5110_Driver_Block_SD.vm"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {C:\Users\Phoenix136\Dropbox\FPGA\Microsemi\Nokia5110_Driver_12_1\designer\Nokia5110_Driver_Block_SD} \
    -design Nokia5110_Driver_Block_SD \
    -fam SmartFusion2 \
    -die PA4M1000_N \
    -pkg tq144 \
    -merge_pdc 0 \
