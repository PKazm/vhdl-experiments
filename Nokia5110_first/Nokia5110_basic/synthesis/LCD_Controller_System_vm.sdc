# Written by Synplify Pro version mapact, Build 2461R. Synopsys Run ID: sid1572325450 
# Top Level Design Parameters 

# Clocks 
create_clock -period 10.000 -waveform {0.000 5.000} -name {LCD_Controller_System|Board_Buttons[0]} [get_ports {Board_Buttons[0]}] 
...
set Inferred_clkgroup_0 [list LCD_Controller_System|Board_Buttons\[0\]]
set Inferred_clkgroup_1 [list FCCC_C0_FCCC_C0_0_FCCC|GL0_net_inferred_clock]
